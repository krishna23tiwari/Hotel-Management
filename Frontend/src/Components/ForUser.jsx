...
const shadow = "shadow-xl hover:shadow-2xl transition-all duration-300";
  ...
  return (
    ...
    >
      <div className="relative h-[50vh] sm:h-[60vh] bg-cover bg-center" style={{ backgroundImage: "url('https://images.pexels.com/photos/462014/pexels-photo-462014.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')" }}>
        <div className="absolute inset-0 bg-opacity-50"></div>
        <div className="absolute top-4 left-6 z-10"></div>
        <div className="absolute bottom-8 left-0 right-0 z-10 flex justify-center">
          <div className="flex flex-wrap items-center gap-4 bg-opacity-40 p-6 rounded-xl">
            <select
              ...
              className={`p-2 rounded-md w-32 sm:w-36 transition-all duration-300 ease-in
                ${darkMode 
            ...
            <input
              ...
              className={`p-2 rounded-md min-w-[150px] sm:min-w-[200px] flex-1 transition-all duration-300 ease-in
                ${darkMode 
                  ? "bg-gray-800 text-white border-gray-700"
                  : "bg-white text-black border-gray-300"}`}
            />
            ...
            <div className="mb-2">
              {room.image.length > 0 ? (
                <img
                  src={room.image[0]}
                  alt={room.room}
                  className={`w-full h-40 sm:h-48 object-cover rounded-xl border 
                    ${darkMode ? "border-gray-700" : "border-gray-300"}`}
                />
              ) : (
                <div className={`w-full h-40 sm:h-48 rounded-xl 

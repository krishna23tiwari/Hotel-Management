...
// const AddState = () => {
//   const [form, setForm] = useState({ stateName: '', code: '' });
...
//     e.preventDefault();
//     if (!form.stateName || !form.code) return alert('Both fields are required');

//     try {
//       await axios.post('http://localhost:4545/addingstate/addstate',{ state: form.stateName, code: form.code }, getAuthHeaders());
//       setForm({ stateName: '', code: '' });
